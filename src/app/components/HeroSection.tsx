...
export const HeroSection = () => {
  return (
    <section className="relative bg-secondary text-white py-12 sm:py-20 md:py-28 flex items-center justify-center overflow-hidden px-6 sm:px-8 md:px-20 min-h-screen">
      {/* Wrapper for Content */}
